...
$_lang['ms.menu_desc'] = 'A friendly online store for MODX Revolution';
...
$_lang['ms.goods.create'] = 'Create';
$_lang['ms.goods.change'] = 'Edit';
...
$_lang['ms.goods.select'] = 'Select product';
